...
/**
 * One line being written up: a single bottle, or a whole combo.
 *
...
function NewOrderScreen() {
  ...
  function addCombo(combo: Combo, size: ComboSize) {
    setLines((current) => {
          ...
          <Panel tone="amber" title="Items" bodyClassName="p-0">
            ...
            {lines.length === 0 ? (
              <p className="px-5 py-6 text-sm text-muted">
                Nothing on the order yet. Search above to add a size, or pick a combo.
              </p>
            ) : (
              <>
